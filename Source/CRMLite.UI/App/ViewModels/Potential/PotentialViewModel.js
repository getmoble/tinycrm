function PotentialViewModel() {
    ...
    self.getPropertyAminities = function () {
        self.isBusy(true);
        var result = CRMLite.dataManager.getData(ko.toJS(self.url.potentialManagegetPropertyAminities));
    ...
    self.createAminity = function () {
        if (self.selectedAminity().modelState.isValid()) {
            ...
            var result = CRMLite.dataManager.postData(ko.toJS(self.url.potentialManageCreateAminity), aminityJson);
            result.done(function (data) {
                if (data) {
...
//            var result = CRMLite.dataManager.postData(ko.toJS(self.url.propertyManageCreateAminity), aminityJson);
//            result.done(function (data) {
//                if (data) {
//                    $('#createAminityForProperty').modal('hide');
//                    self.aminityList.push(new Aminities(aminityJson));
