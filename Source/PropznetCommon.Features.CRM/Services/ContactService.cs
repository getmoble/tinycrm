...
namespace PropznetCommon.Features.CRM.Services
{
    public class ContactService : IContactService
    {
        ...
        readonly IAgentInfoService _agentService;
        readonly IPersonRepository _personRepository;
        public ContactService(IContactRepository contactRepository, IUnitOfWork iUnitOfWork,
            IElasticSearchSettings elasticsearchsettings, IAgentInfoService agentService, IPersonRepository personRepository)
        {
