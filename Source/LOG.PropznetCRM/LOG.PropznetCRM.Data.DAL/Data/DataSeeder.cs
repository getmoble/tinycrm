...
namespace LOG.PropznetCRM.Data.DAL.Data
{
    public class DataSeeder : DropCreateDatabaseIfModelChanges<DataContext>
    {
        protected override void Seed(DataContext context)
        {
            ...
            var logoSetting = new Setting { Key = "logo", Value = "logo.png", CreatedOn = DateTimeOffset.UtcNow, DefaultValue = "props-logo.png" };
            context.Settings.Add(logoSetting);
            context.SaveChanges();

            var pagingSetting = new Setting { Key = "pagingsize", Value = "20", CreatedOn = DateTimeOffset.UtcNow, DefaultValue = "20" };
            ...
            context.SaveChanges();
            var communicationdetail = new List<CommunicationDetail>
            {
               new CommunicationDetail{ Address="The Business Centre\n61 Wellfield Road\nRoath\nCardiff\nCF24 3DG",Email="wilfred@gmail.com", Phone="9658741236",Website="www.wilfred.com"},
            ...
            communicationdetail.ForEach(s => context.CommunicationDetails.Add(s));
            context.SaveChanges();


            //user
            var newAdminAccessRule = AccessRule.CreateNewUserAccessRule();
            context.AccessRules.Add(newAdminAccessRule);
            context.SaveChanges();

            var newUserAccessRule = AccessRule.CreateNewUserAccessRule();
            ...
            {
                new Property{Area=1200,BudgetFrom=1000,BudgetTo=20000,Floor=2,LocationId=2,PropertyCategoryId=3,PropertyType=PropertyType.Rent,RefId="P01",StateId=3,CreatedBy=1,UpdatedBy=1},
                new Property{Area=1200,BudgetFrom=1000,BudgetTo=20000,Floor=1,LocationId=3,PropertyCategoryId=2,PropertyType=PropertyType.Rent,RefId="P02",StateId=1,CreatedBy=1,UpdatedBy=1},
                new Property{Area=1200,BudgetFrom=1000,BudgetTo=20000,Floor=0,LocationId=4,PropertyCategoryId=3,PropertyType=PropertyType.Rent,RefId="P03",StateId=3,CreatedBy=2,UpdatedBy=2}
            };
            property.ForEach(s => context.Properties.Add(s));
            context.SaveChanges();
            ...
            {
                new ToDo{StartDate=Convert.ToDateTime("1/6/2015"),EndDate=Convert.ToDateTime("1/6/2015"),DueDate=Convert.ToDateTime("1/6/2015"),IsRecurring=true,Title="New Work",CreatedBy=1,Time=Convert.ToDateTime("5:00")},
                new ToDo{StartDate=Convert.ToDateTime("1/6/2015"),EndDate=Convert.ToDateTime("1/6/2015"),DueDate=Convert.ToDateTime("1/6/2015"),IsRecurring=true,Title="New Work",CreatedBy=1,Time=Convert.ToDateTime("5:00")},
                new ToDo{StartDate=Convert.ToDateTime("1/6/2015"),EndDate=Convert.ToDateTime("1/6/2015"),DueDate=Convert.ToDateTime("1/6/2015"),IsRecurring=true,Title="New Work",CreatedBy=1,Time=Convert.ToDateTime("5:00")},
                new ToDo{StartDate=Convert.ToDateTime("1/6/2015"),EndDate=Convert.ToDateTime("1/6/2015"),DueDate=Convert.ToDateTime("1/6/2015"),IsRecurring=true,Title="New Work",CreatedBy=1,Time=Convert.ToDateTime("5:00")}
            };
            ...
            context.SaveChanges();
            var toDoMaps = new List<ToDoMap>
            {
                new ToDoMap{ToDoId=1,EntityType=EntityType.Lead,CreatedBy=1},
                new ToDoMap{ToDoId=2,EntityType=EntityType.Lead,CreatedBy=1},
                new ToDoMap{ToDoId=3,EntityType=EntityType.Lead,CreatedBy=2},
                new ToDoMap{ToDoId=1,EntityType=EntityType.Account,CreatedBy=1},
                new ToDoMap{ToDoId=1,EntityType=EntityType.Account,CreatedBy=1},
                new ToDoMap{ToDoId=1,EntityType=EntityType.Account,CreatedBy=2}
            };
            toDoMaps.ForEach(s => context.ToDoMaps.Add(s));
            context.SaveChanges();
        }
    }
}
