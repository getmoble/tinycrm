...
using LOG.PropznetCRM.Data.ViewModel.Potential;
...
{
    public class PotentialApiController : CRMBaseController
    {
        ...
        public ActionResult GetAllPotential()
        {
            return ExecuteIfValid(() =>
            {
                ...
                {
                    var potentials = _potentialService.GetAllPotentials(WebUser.Id, WebUser.PermissionCodes);
                    ...
                    var propertytype = Enum.GetValues(typeof(PropertyType)).Cast<PropertyType>();
        ...
        public ActionResult CreatePotential(PotentialModel potentialModel)
        {
            ...
            _potentialService.CreatePotential(potentialModel);
        ...
        {
            if (potentialModel.PropertyId.HasValue)
            {
                var propertyModel = new PropertyModel
                {
                    Area = potentialModel.Area,
